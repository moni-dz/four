...
pub(super) fn sequential_arithmetic_jpeg() -> Vec<u8> {
    // Official libjpeg-turbo `testimgari.jpg` interoperability fixture.
    decode_base64(include_str!("sequential_arithmetic_fixture.txt"))
}

pub(super) fn progressive_arithmetic_jpeg() -> Vec<u8> {
    // Generated by libjpeg-turbo 3.2.0 from its official `testorig.ppm` fixture.
    decode_base64(include_str!("progressive_arithmetic_fixture.txt"))
}
